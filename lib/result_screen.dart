...
import 'package:deutsche_lingo/exam_screen.dart';
import 'package:deutsche_lingo/main.dart';
...
class ResultScreen extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildResultRow('Name', studentName),
            if (studentClass != null && studentClass!.isNotEmpty)
              _buildResultRow('Class', studentClass!),
            if (studentId != null && studentId!.isNotEmpty)
              _buildResultRow('Student ID', studentId!),
          ],
        ),
      ),
    );
  ...
  String _getGradeMessage(String grade) {
    switch (grade) {
      ...
      case 'C':
        return '👍 Fair performance. Keep practicing!';
      case 'D':
