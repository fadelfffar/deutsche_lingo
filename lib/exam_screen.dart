  ...
  Widget _buildProgressBar() {
    return ClipRRect(
      ...
      child: LinearProgressIndicator(
        ...
        valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFFDD0000)),
      ),
    );
  }
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Text(
              isCorrect ? '✓ Richtig! Sehr gut!' : '✗ Falsch! Nicht aufgeben!',
  ...
  Widget _buildSubmitButton() {
    ...
    return ElevatedButton(
      ...
      child: Column(
        ...
        children: [
          Text(
            isLastQuestion ? 'Quiz beenden' : 'Antwort bestätigen',
            style: const TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.w500,
              color: Colors.white,
